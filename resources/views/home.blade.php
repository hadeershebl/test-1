        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <br>
                    <br>
                    {{-- show all created sessions for this teacher  --}}
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header text-primary"  style="font-weight: bold">{{ __('Last Created Sessions by you') }}</div>
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                @foreach($classes as $key=>$class)
                                <a href="{{route('classroom', ['id' => $class->id])}}">{{$key + 1}}.
                                    {{$class->name}}</a>
                                <br />
                                @endforeach
                            </div>
